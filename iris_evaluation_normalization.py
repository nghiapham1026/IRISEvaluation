...
# Define models to evaluate, wrapped in pipelines for preprocessing with MinMaxScaler
models = {
    "Naive Bayes": Pipeline([('scaler', MinMaxScaler()), ('classifier', GaussianNB())]),
    "Support Vector Machine": Pipeline([('scaler', MinMaxScaler()), ('classifier', SVC(probability=True))]),  # Enable probability for ROC AUC
    "Random Forest": RandomForestClassifier(),
    "XGBoost": xgb.XGBClassifier(use_label_encoder=False, eval_metric='logloss'),
    "K-Nearest Neighbors": Pipeline([('scaler', MinMaxScaler()), ('classifier', KNeighborsClassifier())])
}
